<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    import="java.util.*"
    import="com.web.cookie.a01_song.a01_controller.*"
    import="com.web.cookie.a01_song.a04_vo.*"
    %>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">고객 로그인</h1>
                                    </div>
                                    <form class="user" method="post" action="ctmrlogin2">
                                    ...
                                    <div class="form-group">
                                            <input type="text" name="manager" class="form-control form-control-user"
                                                 aria-describedby="emailHelp"
                                                placeholder="담당자명 입력"/>
                                        </div>
